 ...
 * 
 * 
 * gonna base my implementation on this guy's: https://github.com/JavaFXpert/tic-tac-toe-rl/blob/master/
 */
@DeepCopyState
public class GameStateBurlap {
    ...
    // public GameStateBurlap() {

    // }

    // public GameStateBurlap(String gameBoard, String gameStatus) {
