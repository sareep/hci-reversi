...
io.sockets.on('connection', function (socket) {
    ...
    socket.on('spawn_bot', function (payload) {
        ...
        switch (payload.train_method) {
            case "none":
                spawn_bot(port, "rl", payload.name + i, payload.difficulty)

            case "rl_bot":
                spawn_bot(port, "rl", payload.name + i, payload.difficulty)
                spawn_bot(port, "rl", payload.name + i + "_trainer", payload.difficulty, "train")
                break;

            case "ab_bot":
                spawn_bot(port, "ab", payload.name + i, payload.difficulty)
                break;
